...
namespace SharpNeat.Core
{
    ...
    {
        [SerializeField] readonly UpdateMode _updateMode;
        [SerializeField] readonly uint _generations;
        [SerializeField] readonly TimeSpan _timespan;

        //Edição minha 
        [SerializeField] readonly bool _flag;

        #region Constructors

        public UpdateScheme( bool flag )
        {
            _flag = flag;
        }
