        ...
        where TGenome : class, IGenome<TGenome>
    {
        ...
        private IEnumerator AlgorithmThreadMethod()
        {
            ...
            for (; ; )
            {
                ...
                GameMenager.Instance.CurrentGeneration = (int) _currentGeneration;
                UnitySharpNEAT.Utility.Log("Begin performing generation " + _currentGeneration);
                //GameMenager.Instance.getIfCanPlayHand() 
                ...
                if (_pauseRequestFlag || _currentGeneration >= 200)//|| _genomeListEvaluator.StopConditionSatisfied)
                {
